...
<div class="wrapper">
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="/author/profile" class="btn btn-default btn-flat">Profile</a>
								</div>
								<div class="pull-right">
									<a href="/author/logout" id="logout" class="btn btn-default btn-flat">Logout</a>
								</div>
							</li>
						</ul>
					</li>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				<li class="header">N A V I G A T I O N</li>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2017 <a href="http://www.facebook.com/davidbezalellaoli" target="_blank">David Bezalel Laoli</a>.</strong> All rights
		reserved.
	</footer>
